...
use RealEstate\Agents\{ AgentsDto, AgentsModel, AgentsController };
...
class AgentsControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        $this->input = [
            ...
            "agent_name" => "wonder",
            "agent_contact" => "serve",
            "agent_email" => "ucarter@example.org",
            "agent_address" => "I",
            "agent_image" => "State son run only.",
            "agent_fb_account" => "open",
            "username" => "per",
            "password" => "who",
        ];
        $this->dto = new AgentsDto($this->input);
        $this->model = new AgentsModel($this->dto);
        $this->service = $this->createMock("RealEstate\Agents\IAgentsService");
