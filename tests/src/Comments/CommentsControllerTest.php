...
use RealEstate\Comments\{ CommentsDto, CommentsModel, CommentsController };
...
class CommentsControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        $this->input = [
            ...
            "property_id" => 7064,
            "client_id" => 8935,
            "comment_time" => "2021-09-21 18:24:28",
            "comment_date" => "2021-10-01",
            "comment_status" => 6092,
            "admin_id" => 306,
        ];
        $this->dto = new CommentsDto($this->input);
        $this->model = new CommentsModel($this->dto);
        $this->service = $this->createMock("RealEstate\Comments\ICommentsService");
